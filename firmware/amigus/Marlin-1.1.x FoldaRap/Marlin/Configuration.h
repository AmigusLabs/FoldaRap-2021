...
*/
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 150, 150, 150, 60 }

#define STEPS_PER_REVOLUTION_X 1600
#define STEPS_PER_REVOLUTION_Y 1600
#define STEPS_PER_REVOLUTION_Z 1600
#define STEPS_PER_REVOLUTION_E 1600

#define IDLER_TEETH_X 16
#define IDLER_TEETH_Y 16
#define IDLER_TEETH_Z 8

#define MM_PER_INCH 10
#define BELT_PITCH_X (.124 * MM_PER_INCH) //.13
#define BELT_PITCH_Y (.124 * MM_PER_INCH) //.126
#define BELT_PITCH_Z (.122 * MM_PER_INCH) //.131
...
#define AXIS_STEPS_PER_UNIT_Z (STEPS_PER_REVOLUTION_Z / IDLER_TEETH_Z / BELT_PITCH_Z)
#define AXIS_STEPS_PER_UNIT_E 95
...
/**
   ...
   Override with M203
                                        X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 120, 50 }
...
/**
   ...
   Override with M201
                                        X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/
#define DEFAULT_MAX_ACCELERATION      { 1200, 1200, 1200, 3000 }

/**
   Default Acceleration (chsange/s) change = mm/s
   Override with M204
